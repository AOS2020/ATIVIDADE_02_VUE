<template>
    ...
    <div class=" flex items-center justify-center pt-24">
      ...
      <div class="mt-6 flex items-center justify-center gap-x-6 pt-12 pl-24 pr-24">
      ...
      <li v-for="person in people" :key="person.email" class="flex justify-center gap-x-6 py-10">
...
<XMarkIcon @click="removeUser(person.email)" color="red"/>
        </div>
      </li>
    </ul>
</div>
